  ...
  return (
    <nav
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-deep/92 backdrop-blur-xl border-b border-brand-bright/20 py-2"
          : "bg-deep/40 backdrop-blur-md border-b border-white/5 py-2.5 md:py-3"
      }`}
    >
      <div className="mx-auto max-w-7xl px-4 md:px-8 flex items-center justify-between">
        ...
        <a
          href="#oferta"
          className="hidden md:inline-flex items-center gap-2 bg-brand text-on-brand font-mono text-xs tracking-[0.18em] uppercase font-semibold px-5 py-2.5 hover:bg-brand-hover transition-colors"
        >
          <span className="h-1.5 w-1.5 bg-on-brand animate-pulse" />
          Acessar acervo
        </a>
        ...
        <a
          ...
          className={`md:hidden inline-flex items-center gap-1.5 font-mono text-[10px] tracking-[0.16em] uppercase font-bold px-3 py-2 transition-all ${
            scrolled
              ...
              : "text-brand-bright border border-brand-bright/40 opacity-90"
          }`}
        >
          Acessar
        </a>
